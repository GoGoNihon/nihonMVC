...
namespace GoGoNihon_MVC.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public async Task<ActionResult> Register(RegisterViewModel model)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    data.statusCode = (int)statusCodes.successRun;
                    data.callback = "loadUserList";
                    data.message = "User added.";
                    return Json(data);
                }
                AddErrors(result);
                data.statusCode = (int)statusCodes.fail;
                data.message = "User not added; "+result.Errors.First();
            }
            else
            {
                data.statusCode = (int)statusCodes.fail;
                data.message = "User not added; Supplied user data not valid";
            }
        ...
        {
            return View("~/Views/Account/_ResetPassword.cshtml");
